...
class Channel(models.Model):
    ...
    custom_url = models.CharField(max_length=30)
...
class ChannelDetail(models.Model):
    channel = models.ForeignKey(Channel, related_name="channel_detail", on_delete=models.CASCADE)
